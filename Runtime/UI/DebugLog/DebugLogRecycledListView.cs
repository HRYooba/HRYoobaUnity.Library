...
#pragma warning disable 0649
        ...
        [SerializeField]
        private DebugLogConsoleWindow debugLogWindow;
...
#pragma warning restore 0649
        ...
        private DebugLogConsoleWindow window;
        ...
        public void Initialize(DebugLogConsoleWindow window, List<DebugLogEntry> collapsedLogEntries,
        ...
        {
            DebugLogItem logItem = debugLogWindow.PopLogItem();
        ...
        {
            for (int i = topIndex; i <= bottomIndex; i++)
                debugLogWindow.PoolLogItem(logItemsAtIndices[i]);
        }
